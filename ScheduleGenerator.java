...
public class ScheduleGenerator {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Course> approvedSchedule = new ArrayList<>();
    ...
    compare.getConflictions();
    
    approvedSchedule = compare.getPossibleSchedules();

//send comber section to print it out 
       System.out.println("\nPossible Schedule:");
     schedule.printSchedule(approvedSchedule);
